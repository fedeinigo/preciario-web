...
export const messages: Record<Locale, DeepRecord> = {
  es: {
    ...
    goals: {
      ...
      billing: {
        ...
        subtitle: "{count, plural, one {{count} negocio} other {{count} negocios}} registrados",
  ...
  en: {
    ...
    goals: {
      ...
      billing: {
        title: "My billing",
        subtitle: "{count, plural, one {{count} deal} other {{count} deals}} logged",
  ...
  pt: {
    ...
    goals: {
      ...
      billing: {
        ...
        subtitle: "{count, plural, one {{count} negócio} other {{count} negócios}} registrados",
