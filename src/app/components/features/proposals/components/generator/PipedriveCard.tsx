...
export default function PipedriveCard({
  ...
  return (
    <div className="rounded-xl border border-purple-300 bg-gradient-to-br from-purple-50 to-white shadow-md p-5">
      <fieldset>
        <legend className="mb-3 block text-xs font-semibold uppercase tracking-wide text-slate-700">
          {t("modeLabel")}
        </legend>
